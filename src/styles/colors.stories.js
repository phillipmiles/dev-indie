...
const Swatch = ({ color, labelColor, children, ...props }) => (
  <div {...props} sx={{ bg: color, color: labelColor ? labelColor : 'text', borderRadius: 16, p: 4, boxShadow: '0px 4px 8px -2px rgba(0,0,0,0.2)', textAlign: 'center' }}><Paragraph>{color}</Paragraph></div>
)
